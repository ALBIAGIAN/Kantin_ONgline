 ...
 <div id="top">
    <div class="container">
        <div class="col-md-6" data-animate="fadeInDown">
            <ul class="menu">
                <li><a href="profile.php">Welcome, to Home - Food! <?php echo $_SESSION['login']['nama_pelanggan']; ?></a></li>
        ...
        <div class="same-height-row">
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Special for FOOD online</h3>
                    <p>Aplikasi ini di khususkan untuk informasi delivery makanan</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <p>Aplikasi ini akan memberikan informasi lengkap mengenai menu makanan di warung-warung</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
<div class="box text-center" data-animate="fadeInUp">
    <div class="container">
        <div class="col-md-12">
            <h3 class="text-uppercase"> Home - food bekerja sama dengan banyak warung. </h3>
...
<!-- /#content -->
 ...
 <div id="copyright">
    <div class="container">
        <div class="col-md-6">
            <p class="pull-left">© Home - Food</p>
        </div>
        <div class="col-md-6">
            <p class="pull-right">Alright Reserved by Mas Al
            </p>
        </div>
    </div>
</div>
