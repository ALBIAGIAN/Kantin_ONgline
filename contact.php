 ...
 <div id="top">
    <div class="container">
        <div class="col-md-6" data-animate="fadeInDown">
            <ul class="menu">
                <li><a href="profile.php">Welcome, to Home - Food <?php echo $_SESSION['login']['nama_pelanggan']; ?></a>
                </li>
                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <p>kabupaten purwakarta
                                    <br>kecamatan jatiluhur
                                    <br>desa cisereuh
                                    <br>rt009/rw003
                                   <br> <strong>jawa barat</strong>
                                </p>
                            </div>
                            <!-- /.col-sm-4 -->
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <ul>
                                    <li><strong><a href="mailto:">gianz.com</a></strong>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-sm-4 -->
